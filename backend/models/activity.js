...
const activitySchema = new mongoose.Schema(
  {
    ...
    serviceBilling: {
      ...
      customCycleValue: { type: String, trim: true, default: "" },
      customCycleUnit: { type: String, trim: true, default: "" },
      usersOrSeats: { type: String, trim: true, default: "" },
      estimatedValue: { type: String, trim: true, default: "" },
      billingOwner: { type: String, trim: true, default: "" },
      reminderDays: { type: String, trim: true, default: "" },
      renewalPolicy: { type: String, trim: true, default: "" },
      serviceContinuationDecision: { type: String, trim: true, default: "" },
      billingNotes: { type: String, trim: true, default: "" },
      nextCustomerEmailAt: { type: Date, default: null },
