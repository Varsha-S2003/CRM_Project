...
function Sidebar() {
  ...
  const isReportsPage = ["/reports", "/analytics"].includes(location.pathname);
  const activityType = new URLSearchParams(location.search).get("type") || "all";
      ...
      <nav className="sidebar-nav">
        <div className="nav-section">
          ...
          {canSee(["ADMIN","MANAGER","EMPLOYEE"]) && (
            <a
              href="/"
              onClick={(e) => handleNav("/requests", e)}
          ...
          {canSee(["ADMIN","MANAGER","EMPLOYEE"]) && (
            <a
              href="/"
              onClick={(e) => handleNav("/vendors", e)}
              className={`nav-item ${isActive("/vendors") ? "active" : ""}`}
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M21 7.5V6a2 2 0 0 0-2-2h-3"></path>
                <path d="M8 4H5a2 2 0 0 0-2 2v1.5"></path>
                <rect x="3" y="7.5" width="18" height="12" rx="2"></rect>
          ...
          {canSee(["ADMIN","MANAGER","EMPLOYEE"]) && (
            <a
              href="/"
              onClick={(e) => handleNav("/usecases", e)}
              className={`nav-item ${isActive("/usecases") ? "active" : ""}`}
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          {canSee(["ADMIN","MANAGER","EMPLOYEE"]) && (
            <a
              href="/"
              onClick={(e) => handleNav("/documents", e)}
          ...
          {canSee(["ADMIN","MANAGER","EMPLOYEE"]) && (
            <a
              href="/"
              onClick={(e) => handleNav("/payments", e)}
        ...
        <div className="nav-section">
          ...
          {canSee(["ADMIN","MANAGER"]) && (
            <a
              href="/"
              onClick={(e) => handleNav("/analytics", e)}
